...
export const productDetails: Record<string, ProductDetail> = {
  vitamins: {
    overview: [
      ...
      "The Vitamins portfolio spans Biotin, Calcium D Pantothenate (Vitamin B5), Inositol (Vitamin B8), Vitamin A Acetate 325/500 cws, Vitamin A Palmitate 250/500 cws, Vitamin D2 100/500 cws, Vitamin D3 100/500 cws, Vitamin E 50%, Vitamin K1 5% 10%, supplied with COA, Halal, and Kosher documentation and available in sample, small-pack, drum, and bulk quantities.",
    ],
    specs: [
  ...
  "herbal-extracts": {
    overview: [
      ...
      "The Herbal Extracts portfolio spans 5-HTP, Ginseng Extract, Grape Seed Extract, Quercetin, Resveratrol, Rutin, Silymarin 80%, supplied with COA, Halal, and Kosher documentation and available in sample, small-pack, drum, and bulk quantities.",
    ],
    specs: [
  ...
  sweeteners: {
    overview: [
      ...
      "The Sweeteners portfolio spans Acesulfame K, Allulose, Aspartame, Erythritol, Mannitol, Neotame, Potassium Sorbate, Sorbic Acid, Sucralose, Trehalose, Xylitol, supplied with COA, Halal, and Kosher documentation and available in sample, small-pack, drum, and bulk quantities.",
    ],
    specs: [
  ...
  proteins: {
    overview: [
      ...
      "The Proteins portfolio spans Pea Protein, Rice Protein Powder, Whey Protein Concentrate, supplied with COA, Halal, and Kosher documentation and available in sample, small-pack, drum, and bulk quantities.",
    ],
    specs: [
