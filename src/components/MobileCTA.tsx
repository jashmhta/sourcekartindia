    ...
    >
      <div className="flex items-center justify-center gap-3 py-2.5">
        ...
        <Link
          ...
          className="flex h-11 w-11 items-center justify-center rounded-full bg-black/85 border border-[#25D366]/40 backdrop-blur-md touch-manipulation transition-transform active:scale-90 shadow-lg shadow-black/40"
