  ...
  return (
    <section className="section-black py-20 md:py-28 lg:py-44">
      <div className="site-container">
        ...
        <SplitText
          as="h2"
          text={`Ingredients are the molecules between your formulation and your customer's trust. We supply that trust, consistently, competitively, on time, from Mumbai to all of India.`}
